...
.side .foot{margin-top:auto;color:var(--mut);font-size:11px;line-height:1.5}
/* main */
...
.shot img{width:100%;display:block;aspect-ratio:4/3;object-fit:contain;background:#fff}
